...
<h1> <a href="/editor/mynews"> News List (<?= $count ?? 0 ?>) </a></h1>

 <form>
     <div class="input-group mb-3">
         <input type="text" class="form-control"
                placeholder="Search for News with Title"
 ...
 <table class="table">
    ...
    <?php if ($news): foreach ($news as $i => $new): ?>
       <tr>
           ...
           <td>
               <a href="/editor/updatenews?_id=<?php echo $new['_id'] ?>" button type="button" class="btn btn-primary">Update/View</a>
           </td>
       </tr>
    <?php endforeach; 
