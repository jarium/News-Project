...
<h3> User: <?= $user['username'] ?></h3> <hr>
    ...
    <form method="post">
    <h3> Role: Editor  <button type="submit" name="user" class="btn btn-danger" onclick="return confirm('Demote <?= $user['username'] ?> to User?');">Demote</button></h3>
    </form>
    <?php endif; ?>

<?php elseif (!$warning): ?>
  <div style="font-size:large"class="alert alert-warning">No Users/Editors Found Matching The Id, You Can Check the Id of Users/Editors <a href ="/mod/checkid">Here </a></div>
<?php endif; ?>
</body>
</html>